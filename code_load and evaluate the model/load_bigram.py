...
model_100 = load_model("models_bigram_10_folds/model_bigram_batch_size_100_best.h5")   # model based on batch_size = 100


X_bigram_20 = load_npz("X_bigram_20.npz")
y_20 = np.load("y_20.npy", allow_pickle=True)

# Evaluate the model on the loaded test data
loss_100, accuracy_100 = model_100.evaluate(X_bigram_20, y_20)
print("Loss_100: ", loss_100)
print("Accuracy_100: ", accuracy_100)

y_pred_probs_100 = model_100.predict(X_bigram_20)    # Get the predicted probabilities
