from read_balancing import balanced_texts, balanced_labels
...
bigram = bigram_vectorizer.fit_transform(balanced_texts_cleaned) # Fit the vectorizer on the training data and transform it
